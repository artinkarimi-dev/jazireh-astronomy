...
function jazireh_theme_disable_emoji_assets()
{
...
add_action('init', 'jazireh_theme_disable_emoji_assets');

function jazireh_theme_disable_tinymce_emoji_plugin($plugins)
{
