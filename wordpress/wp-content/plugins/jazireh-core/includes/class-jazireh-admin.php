...
final class Jazireh_Admin
{
    ...
    public static function menu()
    {
        ...
        add_submenu_page('jazireh-dashboard', 'تنظیمات جزیره', 'تنظیمات', 'manage_options', 'jazireh-settings', array('Jazireh_Settings', 'render_settings_page'));
        ...
        add_submenu_page('jazireh-dashboard', 'ترجمه‌های APOD', 'ترجمه‌های APOD', 'edit_posts', 'edit.php?post_type=' . Jazireh_APOD_Editorial::POST_TYPE);
        add_submenu_page('jazireh-dashboard', 'افزودن ترجمه APOD', 'افزودن ترجمه APOD', 'edit_posts', 'post-new.php?post_type=' . Jazireh_APOD_Editorial::POST_TYPE);
        add_submenu_page('jazireh-dashboard', 'رویدادهای نجومی', 'رویدادهای نجومی', 'edit_posts', 'edit.php?post_type=' . Jazireh_Events::POST_TYPE);
        add_submenu_page('jazireh-dashboard', 'افزودن رویداد', 'افزودن رویداد', 'edit_posts', 'post-new.php?post_type=' . Jazireh_Events::POST_TYPE);
    }
    ...
    public static function render_dashboard()
    {
        ...
        <div class="wrap jazireh-admin-wrap" dir="rtl">
            <div class="jazireh-admin-hero">
                ...
                <h1>جزیره نجوم</h1>
                <p>خبرهای علمی سایت را از این بخش مدیریت کنید. هر تغییری بعد از انتشار، مستقیماً در رابط React نمایش داده
                    می‌شود.</p>
                <div class="jazireh-admin-actions">
                    <a class="button button-primary button-hero"
                        href="<?php echo esc_url(admin_url('post-new.php?post_type=' . Jazireh_News::POST_TYPE)); ?>">افزودن خبر
                        جدید</a>
                    <a class="button button-hero"
                        href="<?php echo esc_url(admin_url('edit.php?post_type=' . Jazireh_News::POST_TYPE)); ?>">مدیریت
                        اخبار</a>
                </div>
            </div>
            ...
            <div class="jazireh-help">
                <h2>روش ثبت خبر</h2>
                <ol>
                    <li>عنوان خبر را بنویسید.</li>
                    <li>خلاصه و متن کامل را وارد کنید.</li>
                    <li>دسته‌بندی و تصویر شاخص را انتخاب کنید.</li>
                    <li>زمان مطالعه و حالت خبر ویژه را تنظیم کنید.</li>
                    <li>روی انتشار بزنید.</li>
                </ol>
            </div>
        </div>
        <?php
    ...
    public static function styles()
    {
        ...
        <style>
            ...
            .jazireh-admin-hero {
                border-radius: 24px;
                padding: 38px;
                background: radial-gradient(circle at 10% 10%, rgba(245, 158, 11, .25), transparent 38%), linear-gradient(135deg, #090f1f, #151b2e);
                color: #fff;
                box-shadow: 0 18px 48px rgba(15, 23, 42, .22)
            }

            .jazireh-admin-hero span {
                color: #fbbf24;
                font-weight: 700
            }

            .jazireh-admin-hero h1 {
                font-size: 34px;
                margin: 10px 0;
                color: #fff
            }

            .jazireh-admin-hero p {
                font-size: 15px;
                line-height: 2;
                max-width: 720px;
                color: #cbd5e1
            ...
            .post-type-jazireh_news #postexcerpt .inside p {
                display: none
            }
